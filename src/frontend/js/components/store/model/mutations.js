    ...
    Object.assign(crudMutations, {
        addItem(state,  {item, index}){
            ...
            if(typeof  index !== 'undefined'){
                state.list.splice(index, 0, item[idAttribute].toString());

            }else {
                state.list.push(item[idAttribute].toString());
            }
        }
    });
        ...
        Object.assign(crudMutations, {
            ...
            fetchListSuccess(state, response) {
               ...
               state.list = items.map(m => m[idAttribute].toString());
                ...
                console.log("LIST",  state.isFetchingList);
